...
class PetkitYumshareDual extends DeviceConfigurationDTO implements ConfigurationInterface, Video, Snapshot, HasCamera
{
    ...
    // with {"action":"feed","amount1":N,"amount2":M} on the action/start
    // topic instead (see PetkitYumshareDual::action()), so amounts can be
    // set per call rather than always using whatever's configured.
