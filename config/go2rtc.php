...
return [
    ...
    // Camera previews are shown as a cached still frame - ffmpeg grabs it from
    // go2rtc's /api/frame.mp4 - instead of a live stream.
    'thumbnail' => [
        'ttl' => (int) env('GO2RTC_THUMBNAIL_TTL', 10),        // cache seconds
